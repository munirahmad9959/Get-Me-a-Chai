    ...
    return (
        <nav className='bg-gray-900 text-white flex justify-between px-4 h-16 items-center'>
            ...
            <div className='relative'>
                {session && <>
                    <button onClick={() => setShowdropdown(!showdropdown)} onBlur={() => {  //onBlur an event in react the triggers when an element loses focus
                        setTimeout(() => {
                    ...
                    <div id="dropdown" className={`z-10 ${showdropdown ? "" : "hidden"} absolute left-[185px] bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}>
                ...
                {session && <button className='text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2'
